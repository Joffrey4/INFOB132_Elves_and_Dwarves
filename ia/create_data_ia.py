...
def create_data_ia(map_size, id):
    ...
    order_unit['if_right'] = [(map_size,map_size), (map_size - 2,map_size), (map_size-1,map_size), (map_size,map_size - 2), (map_size - 1,map_size - 1), (map_size - 2 ,map_size), (map_size - 1,map_size - 2), (map_size - 2,map_size - 1)]
    print order_unit
